        ...
        describe '#coerce' do
          ...
          context 'for Boolean values' do
            it 'returns a true value' do
              expect(
                described_class.new(type: SalarySummary::Boolean, value: true).coerce
              ).to be true
            end

            it 'returns a false value' do
              expect(
                described_class.new(type: SalarySummary::Boolean, value: false).coerce
              ).to be false
            end

            it 'returns nil when value is not parseable' do
              expect(
                described_class.new(type: SalarySummary::Boolean, value: '').coerce
              ).to be_nil
            ...
            it 'returns nil when value is nil' do
              expect(
                described_class.new(type: SalarySummary::Boolean, value: nil).coerce
              ).to be_nil
            end
          end
