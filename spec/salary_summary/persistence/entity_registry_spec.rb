    ...
    describe EntityRegistry do
      ...
      describe '#add entity' do
        ...
        it "doesn't add another object with same ID and class when already present" do
          ...
          another_salary = Entities::Salary.new(id: 123, amount: 1400.0, period: Date.parse('07/09/2017'))
        ...
        it 'adds another entity object with same ID but different class' do
          ...
          salary = Entities::Salary.new(id: id, amount: 1400.0, period: Date.parse('07/09/2017'))
          ...
          expect(subject.entities).to have_key("salarysummary::persistence::anotherentity>>#{id}")
          ...
          expect(
            subject.entities.dig("salarysummary::persistence::anotherentity>>#{id}")
        ...
        it 'adds two objects of same entity and different IDs' do
          ...
          other_salary = Entities::Salary.new(id: 124, amount: 1400.0, period: Date.parse('07/09/2017'))
      ...
      describe '#get class_name, id' do
        it 'returns class_name entity object found by ID' do
          salary = Entities::Salary.new(id: BSON::ObjectId.new, amount: 1400.0, period: Date.parse('07/09/2017'))

          subject.add(salary)

          expect(
            subject.get(Entities::Salary, salary.id)
          ).to equal salary
        end
      ...
      describe '#delete entity' do
        ...
        it 'returns nil if no entity was removed' do
          expect(
            subject.delete(Entities::Salary.new(id: BSON::ObjectId.new))
          ).to be_nil
        end
      end
    end
