...
require 'salary_summary/repositories/update_error'
require 'salary_summary/repositories/delete_error'
require 'salary_summary/repositories/invalid_entity_error'
